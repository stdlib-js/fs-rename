...
```javascript
import rename from 'https://cdn.jsdelivr.net/gh/stdlib-js/fs-rename@v0.2.3-deno/mod.js';
```

You can also import the following named exports from the package:

```javascript
import { sync } from 'https://cdn.jsdelivr.net/gh/stdlib-js/fs-rename@v0.2.3-deno/mod.js';
```
